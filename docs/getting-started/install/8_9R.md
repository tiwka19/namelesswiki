...
You need to know your DDR type (DDR4/DDR5) before updating the firmware. If you don't, you need to MSM.
:::
...
:::note
8 / 8 Pro users can dirty flash. The required firmware is included in the ROM.
:::
